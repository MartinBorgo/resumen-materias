...
- **Carencia de Ambigüedad**: Idealmente, un solo significado para cada construcción sintáctica que se puede escribir. Una construcción ambigua permite dos o más interpretaciones distintas. La ambigüedad es un problema medular en todo diseño de lenguaje. El problema de ambigüedad surge por lo común no en la estructura de elementos individuales de programa, sino en la interacción entre diferentes estructuras.
