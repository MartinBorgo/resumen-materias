...
>El índice *H* es un sistema propuesto por Jorge Hirsch, de la universidad de California, para medir la calidad profesional de físicos y de otros científicos, en función de la cantidad de citas que han recibido sus artículos científicos. Se calcula ordenando de mayor a menor los artículos científicos según el número de citas recibidas, siendo el índice *H* el número en el que coinciden el número de orden con el número de citas, es decir, un científico tiene índice *H*, si ha publicado *H* trabajos con al menos *H* cintas cada uno.
