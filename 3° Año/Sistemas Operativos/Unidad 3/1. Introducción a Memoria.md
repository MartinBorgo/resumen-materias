...
>En los sistemas operativos más modernos se utiliza un esquema de segmentación paginada, el programa se divido en distintos segmentos correspondientes a cada una de las rutinas del programa, al momento de subir esos segmentos a memoria el sistema operativo le asigna un conjunto de páginas en las que se va a ubicar el segmento.
...
- En los sistemas por demanda el procesador se va pidiendo las instrucciones a medida que el procesador las va solicitando, en el sistema de predicción se sube un grupo de instrucciones/datos al mismo tiempo, esto produce polución en los distintos niveles de cache.