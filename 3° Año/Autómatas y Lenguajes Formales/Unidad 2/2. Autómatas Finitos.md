...
>- **Clausura transitiva de la relación lambda ($\Lambda^+$)**: dado un conjunto de estados { *p, q, r* } si ***(p, q)*** poseen una relación lambda, y además ***(q, r)*** a su vez poseen una relación lambda, entonces ***(q, r)*** también poseen una relación lambda.
