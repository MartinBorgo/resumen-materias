Las unidades son el mecanismo que proporcionan los lenguajes de programación mediante los cuales, los programadores pueden separar un programa en programas más pequeños siguiendo cierta coherencia y lógica. Esto le otorga a los lenguajes mayor eficiencia, legibilidad y verificación.
...
Para responder a estas necesidades, los lenguajes crearon mecanismos que permite agrupar distintos subprogramas relacionados en un mismo lugar, de modo que puedan ser compilados por separado sin necesidad de compilar todo el programa cada vez que se modifica algo de estas unidades. De esto se desprende las distintas maneras de compilar que emplea cada uno de los lenguajes, entre ellas están:

- **Compilación separada**, también conocida como compilación modular, es una técnica utilizada en la programación y desarrollo de software que permite dividir un programa grande en módulos más pequeños y manejables, que se pueden compilar por separado antes de ser enlazados juntos para formar la aplicación final.
