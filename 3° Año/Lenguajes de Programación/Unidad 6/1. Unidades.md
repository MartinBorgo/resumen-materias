...
De estas distintas semánticas se desprenden los dos grandes modelos de pasajes de parámetros (modelos conceptuales) que conocemos hoy en día, el pasaje ***por copia de valor*** y el pasaje ***por referencia***, que al mismo tiempo poseen variantes.
