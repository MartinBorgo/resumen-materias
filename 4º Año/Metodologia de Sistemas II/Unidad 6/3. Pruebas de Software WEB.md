...
Para lograr que estas estrategias se lleven adelante con exito se deberá:
...
4. La interfaz completa se prueba contra los casos de uso seleccionados y las semántica de navegación a fin de descubrir errores en la semántica de la interfaz. En esta etapa se lleva a cabo una serie de pruebas de usabilidad.
...
- **Guiones CGI (Common Gateway Interface)**: Las pruebas de caja negra se realizan con énfasis sobre la integridad de los datos y del procesamiento del guión. Además, la prueba de rendimiento puede realizarse para garantizar que la configuración del lado del servidor puede alojar las demandas de procesamiento de múltiples invocaciones de los guiones CGI.
...
Por lo general también se suelen realizar pruebas de semántica para la interfaz de usuario. Esta prueba evalúa cuán bien cuida el diseño a los usuarios, ofreciendo instrucciones claras, entregando retroalimentación y mantiendo consistencia en su lenguaje y enfoque.
