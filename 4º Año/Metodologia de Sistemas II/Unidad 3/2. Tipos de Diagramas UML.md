...
No pertenece estrictamente al enfoque orientado a objeto, pero es una técnica para captura de requerimientos que ayuda al analista a comprender la forma en que un sistema deberá comportarse. Los casos de usos constan de los siguientes elementos:
...
Es un diagrama de interacción que muestra como se comunican los distintos objetos que forman parte del sistema entre si durante el transcurso del tiempo.
