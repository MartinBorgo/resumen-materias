...
El aspecto crucial de los componentes es que representan piezas que son adquiribles y actualizables de manera independiente. También es importante recordar tener precaución con los componentes excesivamente detallados, ya que demasiados componentes pueden ser difíciles de gestionar, especialmente cuando surgen problemas de versiones, llevando al conocido "infierno DLL".
Los componentes en UML no introducen conceptos radicalmente nuevos. Están conectados a través de interfaces implementadas y requeridas, a menudo utilizando la notación de "socket-ball" (enchufe y bola), similar a los diagramas de clase.
