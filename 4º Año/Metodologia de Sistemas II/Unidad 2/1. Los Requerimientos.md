...
- ***Validación***: verificar que los requerimientos realmente definen el sistema que quiere el cliente. Los requerimientos deben ser validados para poder:
	...
	- Asegurar que el documento de especificación de requerimientos define el software adecuado, es decir, el que espera el usuario.
