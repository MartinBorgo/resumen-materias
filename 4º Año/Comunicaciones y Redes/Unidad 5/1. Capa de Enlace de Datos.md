...
Las técnicas de detección de errores permiten al receptor detectar los errores que se han producido en los bits de las tramas. Aunque se utilicen bits de detección de errores, puede que sigan existiendo errores que no han sido detectados. Por tanto, intentaremos elegir un esquema de detección de errores que haga que la probabilidad de que se produzcan estos casos sea pequeña. Cuanto más sofisticadas son las técnicas de detección de errores mayores son los recursos adicionales necesarios.
