...
El protocolo de ventana deslizante es un mecanismo de control el flujo que permite al emisor enviar múltiples tramas antes de necesitar una confirmación (ACK), aumentando así la eficiencia y la utilización del canal al máximo. 
...
Uno de los protocolos más relevantes de la capa de enlace de datos es HDLC. No solo porque fue ampliamente utilizado, sino también porque estableció las bases para el resto de protocolos, en los que se usan los mismos o similares formatos y los mismos procedimientos que los empleados en HDLC.
