...
>- **Por dirección IP**: Se utiliza una tabla que asigna direcciones IP a VLAN específicas, de modo que los dispositivos que utilicen ciertas direcciones IP se integren a la VLAN correspondiente. Este método es el menos recomendado ya que las direcciones IP de los equipos puede ser cambiada facilmente.
>
