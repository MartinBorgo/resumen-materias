...
- **Longitud/Tipo**: Contiene la longitud del campo de datos LLC expresado en bytes, o el campo tipo de Ethernet. Este campo va variar dependiendo de si la trama se implemente siguiendo la norma IEEE 802.3 o una especificación primitiva de Ethernet. En cualquier caso, el tamaño máximo de la trama, excluyendo el preámbulo y el SFD, es de 1518 bytes.
...
### Maneras de Configurar una VLAN
