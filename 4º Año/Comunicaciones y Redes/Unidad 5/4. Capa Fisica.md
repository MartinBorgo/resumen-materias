...
>
>1. La **amplitud de pico** es el valor máximo de la señal en el tiempo y normalmente es un valor medido en voltios.
...
>[!note] Velocidad de Transmisión y Ancho de Banda
...
En cualquier medio de transmisión, la energía de la señal disminuye a medida que aumenta la distancia. En medios guiados, esta reducción de energía suele ser exponencial y se expresa como un valor constante en decibelios por unidad de longitud. En medios no guiados, la atenuación depende de la distancia y es influenciada por las condiciones atmosféricas. Se pueden considerar tres aspectos importantes sobre la atenuación:
