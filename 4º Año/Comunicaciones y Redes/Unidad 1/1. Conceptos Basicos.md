...
- **Modelo OSI** (Open Systems Interconection) desarrollado por la Organización Internacional de Estandarización en 1984, es un modelo de 7 niveles para la interconexión o entornos de sistemas abiertos y heterogéneos. Sus capas son las siguientes:
	1. **Aplicación**: Proporciona el acceso al entorno OSI para los usuarios y también proporciona servicios de información distribuida, este nivel esta generalmente integrado por todos los distintos protocolos.
	...
	6. **Enlaces de Datos**: Proporciona un servicio de transferencia de datos seguro a través del enlace físico; envía bloques de datos, llamados tramas, de forma secuencial, llevando a cavo la sincronización, el control de errores (enmascara los errores reales) y de flujo necesarios.
...
>[!note] La Dirección Física - MAC
>La MAC es una dirección de tipo Ethernet de 48 bits, la cual indica exactamente donde está ejecutándose un proceso de forma física.
