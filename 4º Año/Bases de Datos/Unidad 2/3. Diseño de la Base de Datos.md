...
- Para las relaciones de varios a uno con pertenencia total, solo se crearán dos tablas, de la cual una de ellas contendrá todos los atributos de la relación, lo mismo sucede para las relaciones ***uno a uno*** con participación total en uno de sus lados. 

![[varios-uno.png]]

- Para las relaciones uno a uno con participación total de ambos lados, solo se va a crear una única tabla cuyas componentes serán los atributos de una entidad y la clave pública de otra entidad participante de la relación.
...
- Un atributo multivaluado $M$ de una entidad $E$ se representa con una tabla separada $M$ con una columna por cada uno de los atributos, tal que $\{A_M \cup CP_E\}$, donde $A_M$ hace referencia a los múltiples valores de $M$ y $CP_E$ corresponde al conjunto de atributos que corresponden la clave primaria $E$.
