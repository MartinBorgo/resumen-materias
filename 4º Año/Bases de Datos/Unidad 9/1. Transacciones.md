Una transacción es una unidad de programa que accede y posiblemente actualiza varios elementos de información. Una transacción puede contener única sentencia SQL o varias de estas. Las transacciones poseen las siguientes propiedades:
