...
>- `SOME`: Este operador comprueba si algún valor de la relación resultante de la subconsulta satisface la condición de comparación, si esta se cumple para aunque sea un valor, entonces este operador devuelve verdadero.
