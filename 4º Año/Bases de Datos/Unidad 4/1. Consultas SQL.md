...
>Consideremos que una tupla aparece $m$ veces en $r$ y $n$ veces en $s$, entonces cuando se realice una de estas operaciones la cantidad de veces que se repetirá la tupla sera:
...
>Los operadores de subconsultas son un tipo particular de cláusula que se utiliza generalmente en las comparaciones para ver si el valor cumple con dicha condición para la relación resultante de la subconsulta, estos operadores son los siguientes:
...
-- Borra todas las cuentas de la sucursales de Concordia
DELETE FROM cuenta
