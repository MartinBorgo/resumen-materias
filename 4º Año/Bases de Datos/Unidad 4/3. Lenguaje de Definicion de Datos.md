...
SQL también te permite borrar tablas y todos los valores que estas contiene, mediante la cláusula `DROP TABLE` seguida del nombre de la tabla. Además, te permite alterar las tablas mediante la cláusula `ALTER TABLE`, esta cláusula te permite agregar nuevos atributos a las tablas, cambiar el tipo de uno o varios atributos e incluso modificar o agregar restricciones de integridad. Veamos algunos ejemplos:
```sql
