...
2. **Comprensión de los datos**: Esta fase incluye la recolección inicial, descripción, exploración y verificación de la calidad de los datos. Todas estas acciones se llevan a cabo con el fin de verificar la presencia de datos nulos o atípicos, comprender como están distribuidos los datos, etc.
...
El siguiente consiste en seleccionar y aplicar la técnica de minería de datos más apropiada de acuerdo al conjunto de datos y el objetivo a alcanzar. Esto puede implicar la construcción de un modelo predictivo, de clasificación o de segmentación, utilizando alguna de las siguientes técnicas:
- Visualización.
- Redes Neuronales.
...
El resultado de esta etapa es un ***modelo de conocimiento*** que representa patrones de comportamiento observados o relaciones de asociación entre las variables del problema. Es posible emplear varias técnicas al mismo tiempo para generar distintos modelos, aunque cada técnica puede requerir una transformación deferente de los datos.
