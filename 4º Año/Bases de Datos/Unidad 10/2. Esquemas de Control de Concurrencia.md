...
Las reglas de escritura de Thomas son un conjunto de reglas utilizadas por este tipo de protocolos para mejorar la concurrencia durante el control de concurrencia, estas reglas ayudan a manejar conflictos de escritura y lectura entre transacciones de manera eficiente. De forma resumida estas reglas dicen lo siguiente:
