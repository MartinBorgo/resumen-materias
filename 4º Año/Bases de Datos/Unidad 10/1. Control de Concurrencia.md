...
Consiste en construir un grafo de precedencia $G = (V, E)$, donde $V$ es un conjunto de vértices y $E$ es un conjunto de aristas. El conjunto de vértices consta de todas las transacciones que participan en el cronograma. El conjunto de aristas consta de todas las aristas $T_i$ → $T_k$ para las cuales se cumple una de las siguientes condiciones:
