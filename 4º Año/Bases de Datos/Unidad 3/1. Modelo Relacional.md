...
$$
- **Renombramiento**. Formalmente denotada como $\rho_x(E)$, donde $E$ es una expresión del álgebra relacional y $x$ el nuevo nombre que hace referencia a esa relación. Nos permite *nombrar* resultados de operaciones en álgebra relacional, por lo tanto, nos permite referenciar una relación a través de múltiples nombres.
