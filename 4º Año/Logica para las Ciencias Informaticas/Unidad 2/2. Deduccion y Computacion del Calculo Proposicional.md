...
#### Cláusulas de Horn
Una cláusula de Horn es una cláusula que posee a lo suma un literal positivo $¬A \vee \cdots \vee ¬A_N \vee B_1$. Estas se puede reescribir de la siguiente manera:
