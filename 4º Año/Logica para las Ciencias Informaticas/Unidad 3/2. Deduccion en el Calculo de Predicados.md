...
Una variable se dice ligada si la misma aparece junto a un cuantificador o es igual a la variable que aparece junto al cuantificador y se encuentra dentro de su alcance. A las variables que no cumplen con ninguna de estas condiciones se las considera ***libres***. Para mayor claridad veamos ahora unos ejemplos:
