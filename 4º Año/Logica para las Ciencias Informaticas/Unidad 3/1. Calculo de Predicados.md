...
La palabra ***predicado*** tiene varios significados, entre ellos se considera a un predicado como *la afirmación de una cualidad, atributo, propiedad de un individuo* o también como *la parte de una sentencia que expresa lo que se dice del sujeto*. Para la oración "*Pedro es alto*" se dice que el individuo Pedro (sujeto) tiene el atributo o propiedad de ser alto (predicado).
