...
1. Conjunto contable no vacío de letras predicativas $p_k^n$ para todo $k$ y $n$ natural.
2. Conjunto contable y posiblemente vacío de letras funcionales $f_k^n$ para todo $k$ y $n$ natural.
3. Conjunto numerable de variables $x, y, z, x_1, x_2, \cdots$, generalmente se utilizan las últimas letras del abecedario para denotar a las variables.
4. Conjunto numerable y posiblemente vacío de constantes $a, b, c, a_1, a_2, \cdots$, generalmente se utiliza las primeras letras del abecedario para denotar a las constantes.
...
4. Para los conectivos introducidos por reescritura:
	...
	- $s$ satisface $A \vee B$ si y solo si $s$ satisface $A$ o $B$.
