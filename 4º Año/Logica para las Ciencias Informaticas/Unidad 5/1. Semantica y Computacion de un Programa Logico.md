...
>El universo o dominio de Herbrand pueden ser finitos, pero si en $S$ existe al menos una letra funcional en dicho conjunto el universo de Herbrand pasa a ser infinito. En caso de que se necesite ver un ejemplo ir a las filminas de la cátedra.
...
Una interpretación de Herbrand de $S$ es una interpretación de Herbrand del lenguaje de $S$. Un modelo de Herbrand de $S$ es una interpretación de Herbrand de $S$ que al mismo tiempo es un modelo de $S$. Dado un programa lógico $P$, una interpretación de Herbrand de $P$ es una interpretación de Herbrand del lenguaje de $P$. Se dice que una interpretación $\mathscr{I}$ es un modelo para un conjunto $S$ de fórmulas bien formadas en $P$, si todas las fórmulas bien formadas de $S$ son verdaderas en dicha interpretación $\mathscr{I}$.
