...
Sorprendentemente, las nociones de consistencia y validez están relacionadas, a pesar de ser conceptos diferentes, ya que decir que un argumento es válido equivale a decir que algo es imposible que las premisas sean verdaderas y la conclusión falsa. De la misma manera si un conjunto de sentencias es inconsistente es equivalente a decir que es imposible que todas las sentencias no pueden ser simultáneamente verdaderas.
...
Si la teoría de pruebas solo infiere respuestas correctas en acuerdo con la semántica se dice que es ***sana, sensata o sólida***. Si dicha teoría de pruebas además genera todas las respuestas correctas se dice que la misma es ***completa***.
